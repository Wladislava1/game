...
const MiniPlayPage = () => {
  ...
  const handleShowClick = (index) => {
    setCurrentShow(index === currentShow ? 0 : index)
  }
            ...
            <div className="grid grid-flow-col grid-rows-3">
                    ...
                    <div className="grid grid-flow-col grid-rows-3 gap-5 bg-indigo-200 border-4 rounded-3xl p-5">
                        <div className="row-start-1 row-end-2 text-center">
                            <div 
                                ...
                                className="flex flex-col items-center right-0">
                                <img
                ...
                <div className="row-start-1 row-end-2 py-5 pr-15 flex justify-end">
                    <div className="flex flex-row items-start gap-5">
                        <button 
                            onClick={handleReset}
                            className="w-30 h-30 bg-yellow-400 rounded-3xl flex items-center justify-center border-4 border-solid shadow-lg hover:bg-yellow-500 transition text-7xl">
                            <img
                                src="/img/buttons/заново.png"
                                alt="заново"
                ...
                <div className="row-start-2 row-end-4 text-center px-15">
                    <div className="h-full w-full border-4 rounded-3xl bg-indigo-200 bg-clip-border flex items-center justify-center">
                        <TicTac onReset={resetRef} currentShow={currentShow}/>
                    </div>
                </div>
            </div>
        </div>
